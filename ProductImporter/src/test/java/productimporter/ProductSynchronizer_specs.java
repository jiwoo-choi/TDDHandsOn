...
public class ProductSynchronizer_specs {
    ...
    void sut_correctly_saves_products(WayneEnterprisesProduct[] products) {
        ...
        assertThat(spy.getLog()).usingFieldByFieldElementComparator().containsAll(expected);
    }
    ...
    void sut_really_does_not_save_invalid_product() {
        // Arrange
        var product = new Product("supplierName", "productCode", "productName", BigDecimal.TEN, BigDecimal.ONE);
