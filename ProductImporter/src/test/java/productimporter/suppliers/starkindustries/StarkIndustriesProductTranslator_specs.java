...
public class StarkIndustriesProductTranslator_specs {
    ...
    void sut_correctly_projects_source_properties(StarkIndustriesProduct source) {
        ...
        assertThat(actual.getListPrice()).isEqualByComparingTo(Integer.toString(source.getListPrice()));
        assertThat(actual.getDiscount()).isEqualByComparingTo(Integer.toString(source.getDiscountAmount()));
    }
